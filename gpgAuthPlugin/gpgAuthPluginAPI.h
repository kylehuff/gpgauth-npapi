 ...
 *
 * ./firebreath/prepmake.sh gpgAuthPlugin build\n
 *
 * \subsection osx OSX: cmake/XCode
 *
 * ./firebreath/prepmac.sh gpgAuthPlugin build\n
 *
 * \subsection win Windows: cmake/VS 2005, 2008, 2010
 *
 * firebreath/prep{VS version}.cmd gpgAuthPlugin build\n
 * \n
 *
 * \subsection step4 Step 4: Build the source
 *
 * cmake --build build --config gpgAuthPlugin --target MinSizeRel
 *
 *
 *
 *
...
{
public:
    gpgAuthPluginAPI(const gpgAuthPluginPtr& plugin,
    ...
    ///////////////////////////////////////////////////////////////////////////////
    /// @fn FB::VariantMap gpgAuthPluginAPI::getKeyList(cont std::string& name, int secret_only)
    ///
...
//    );
    ...
    */
    static void genKeyThreadCaller(gpgAuthPluginAPI* api,
        genKeyParams params)
    {
    ...
    static void genSubKeyThreadCaller(gpgAuthPluginAPI* api,
